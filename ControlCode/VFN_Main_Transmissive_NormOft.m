...
expNm = '145Don_635Polar30';

%-- Custom auto save text
% Change at every run
run_msg = 'Repeat #142 once again to see if drift is done now that DM work is done.';
% Change when doing new set of experiments
set_msg = 'Test polychromatic performance in single polarization.';
las_msg = 'superK EXT-4 100%, 635x50nm BW.';   % Laser/Varia settings
...
VXcenter = 15.7718;       % 
VYcenter = 12.7079;       %13.828012-6 (5.8410 is min if X is at 2.8444)
...
vStepRange = 0.02; %Vortex will be scanned +/- this value
                    % ie. scan will be: 
