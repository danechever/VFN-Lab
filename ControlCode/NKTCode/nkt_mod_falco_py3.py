...
class Nkt(SerialDevice):
    ...
    def get_emission(self):
        ...
        ret = self.read_UINTbyte(self.xtrmModuleAddr, 0x30)
        if ret:
            #print("Emission = ON\n")
            return True
        else:
    ...
    def set_emission(self,off_on):
        ...
        if off_on:
            ...
            data = 0
            status = "OFF"
        ret = self.write_UINTbyte(self.xtrmModuleAddr,0x30,data)
    ...
    def get_interlock(self):
        ...
        ret = self.read_UINT16(self.xtrmModuleAddr,0x32)
        if ret:
            print("Interlock : ON\n")
            return 1
        else:
    ...
    def set_interlock(self,data):
        ...
        ret = self.write_UINT16(self.xtrmModuleAddr,0x32,ctypes.c_ushort(data))
        if ret:
            if data:
    ...
    def get_powerlevel(self):
        ...
        ret = self.read_UINT16(self.xtrmModuleAddr, 0x37)
    ...
    def set_powerlevel(self,power_level):
        ...
        ret = self.write_UINT16(self.xtrmModuleAddr,0x37,data)
    ...
    def set_setupbits(self,mode):
        ...
        if mode < 0 or mode > 1:
            ...
            return -1
        data = int(mode)
        ret = self.write_UINT16(self.xtrmModuleAddr,0x31,data)
        if ret:
            if data is 0:
    ...
    def set_statusbits(self,status_val):
        ...
        data = int(status_val)
        ret = self.write_UINT16(self.xtrmModuleAddr,0x66,data)
