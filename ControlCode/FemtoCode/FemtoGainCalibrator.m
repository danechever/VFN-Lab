...
This script uses the femto, redPM, and KLS635 laser to measure the femto
...
- Increase laser power (iteating until all laser powers are sampled)

Optical setups should be:
- KLS635 laser plugged into input port of fiber splitter
...
svnm = '/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_Sample5';
