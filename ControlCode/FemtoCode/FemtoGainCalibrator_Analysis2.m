...
samp1 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_onSuperK_Sample1');
samp2 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_onSuperK_Sample2');
samp3 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_onSuperK_Sample3');
%samp4 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_Sample4');
%samp5 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_Sample5');
...
legend({'Samp1', 'Samp2', 'Samp3', 'Samp4', 'Samp5'}, 'Location', 'southeast')
...
ylabel('Femto Power [V]')
% Save the chosen data for easy access
gain7_fmto = samp1.FMTOmeas(:,gain);
gain7_pm = samp1.PMmeas(:,gain);
...
ylabel('Femto Power [V]')
% Save the chosen data for easy access
gain8_fmto = samp1.FMTOmeas(:,gain);
gain8_pm = samp1.PMmeas(:,gain);
...
ylabel('Femto Power [V]')
% Save the chosen data for easy access
gain9_fmto = samp1.FMTOmeas(:,gain);
gain9_pm = samp1.PMmeas(:,gain);
...
ylabel('Femto Power [V]')
% Save the chosen data for easy access
gain10_fmto = samp1.FMTOmeas(:,gain);
gain10_pm = samp1.PMmeas(:,gain);
...
ylabel('Femto Power [V]')
% Save the chosen data for easy access
gain11_fmto = samp1.FMTOmeas(:,gain);
gain11_pm = samp1.PMmeas(:,gain);
