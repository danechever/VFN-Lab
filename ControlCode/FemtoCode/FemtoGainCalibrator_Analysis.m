...
samp1 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_Sample1');
samp2 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_Sample2');
samp3 = load('/media/Data_Drive/VFN/TestbedData/210428_COV8/GainCalibration_Sample3');
...
title(sprintf('635 Laser - Gain = %d',gain+4))
...
ylabel('Femto Power [V]')
% Save the chosen data for easy access
gain11_fmto = samp5.FMTOmeas(:,gain);
gain11_pm = samp5.PMmeas(:,gain);
