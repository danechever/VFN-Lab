%{
_DE VERSION OF CODE:
This version of the code utilizes the zernfun_DE() function instead of the
    regular zernfun() function.
    - Net effect of this change is that the Zernikes are normalized to
    return RMS values instead of arbitrary values.
    - SEE ZERNFUN_DE() FOR MORE DETAILS
%}
...
switch nargin
    case 3
        z = zernfun_DE(n,m,r,theta);
    case 4
        z = zernfun_DE(n,m,r,theta,nflag);
    otherwise
